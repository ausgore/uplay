        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChildPrice = table.Column<int>(type: "INTEGER", nullable: true),
                    AdultPrice = table.Column<int>(type: "INTEGER", nullable: true),
                    Description = table.Column<string>(type: "TEXT", nullable: true),
                    IsDaily = table.Column<bool>(type: "INTEGER", nullable: false),
                    StartingAt = table.Column<DateTime>(type: "datetime", nullable: true),
                    EndingAt = table.Column<DateTime>(type: "datetime", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastVisitedAnnouncements = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ChildQuantity = table.Column<int>(type: "INTEGER", nullable: true),
                    AdultQuantity = table.Column<int>(type: "INTEGER", nullable: true),
                    ActivityId = table.Column<int>(type: "INTEGER", nullable: false),
                    DiscountId = table.Column<int>(type: "INTEGER", nullable: true),
                    Timeslot = table.Column<string>(type: "TEXT", nullable: true),
                    BookedDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carts_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivityPostalCode = table.Column<string>(type: "TEXT", nullable: false),
                    ChildQuantity = table.Column<int>(type: "INTEGER", nullable: true),
                    AdultQuantity = table.Column<int>(type: "INTEGER", nullable: true),
                    DiscountName = table.Column<string>(type: "TEXT", nullable: true),
                    AppliedDiscount = table.Column<int>(type: "INTEGER", nullable: true),
                    InitialChildPrice = table.Column<int>(type: "INTEGER", nullable: true),
                    InitialAdultPrice = table.Column<int>(type: "INTEGER", nullable: true),
